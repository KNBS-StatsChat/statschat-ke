...
| Answerable accuracy | 0.776 |
| Unanswerable accuracy | 1.000 |
| Exact Match (EM) | 0.069 |
| Token F1 (avg) | 0.179 |
| Semantic Similarity (avg) | 0.362 |
| Pipeline Precision@8 (avg) | 0.099 |
| Pipeline Recall@8 (avg) | 0.793 |
| Pipeline MRR (avg) | 0.713 |
| Pipeline nDCG (avg) | 0.734 |
| Pipeline Page Precision@8 (avg) | 0.078 |
| Pipeline Page Recall@8 (avg) | 0.621 |
| Pipeline Page MRR (avg) | 0.439 |
| Pipeline Page nDCG (avg) | 0.484 |
| FAISS Proxy Precision@8 (avg) | 0.099 |
| FAISS Proxy Recall@8 (avg) | 0.793 |
| FAISS Proxy MRR (avg) | 0.625 |
...
|---|---|
| **Golden answer** | 0.069 |
| **Predicted answer** | The overall year on year inflation rate as measured by the Consumer Price Index (CPI) was 6.9 per cent, in January 2024. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.000 | Semantic=0.381 | Fuzzy=6.9 | EvidenceMatch=True | Scoring=numeric_match
...
**Reasoning:** The question asks for Kenya's year on year inflation rate in January 2024. The first context document directly provides this information, stating that 'The overall year on year inflation rate as measured by the Consumer Price Index (CPI) was 6.9 per cent, in January 2024.' This matches the question's requirements exactly. The second context document mentions 'year on year inflation' but does not provide the specific rate for January 2024. The third context document does not contain relevant information. Therefore, the most relevant information is extracted from the first context document.

**Key phrases:** year on year inflation rate; January 2024; 6.9 per cent; year on year inflation

**Predicted source text:**

> Kenya National Bureau of Statistics is ISO 9001:2015 Certified    CONSUMER PRICE INDICES AND INFLATION RATES FOR  JANUARY  2024  The overall <b>year on year inflation</b> rate as measured by the Consumer Price Index (CPI) was <b>6.9 per cent</b>, in <b>January 2024</b>. This means that in January 2024, the general price level was 6.9 per cent higher than that of January 2023. This was mainly driven by increases in prices of commodities under Transport (10.6%); Housing, Water, Electricity, Gas an...
...
**Error:** `500 Server Error: Internal Server Error for url: http://127.0.0.1:8001/search?q=What+was+Kenya%27s+GDP+growth+rate+in+Quarter+3+of+2023%3F&content_type=all&debug=true`
...
**Reasoning:** The question asks for the consumer price index inflation rate in February 2025. The most relevant context is from Doc1 and Doc2, both titled 'Kenya Consumer Price Indices and Inflation Rates Highlights February 2025' and 'Kenya Consumer Price Indices and Inflation Rates February 2025' respectively, both published on 01 January 2024. These documents provide the exact inflation rate for February 2025, which is 3.5 per cent. The context from Doc1 states, 'Overall year-on-year (annual) inflation rate as measured by the Consumer Price Index (CPI) was 3.5 per cent, in February 2025'. The context from Doc2 states, 'The annual consumer price inflation as measured by the Consumer Price Index (CPI) was 3.5 per cent in February 2025'. Both documents are from the same publication date and title, making them the most relevant sources for the answer.

**Key phrases:** Overall year-on-year (annual) inflation rate as measured by the Consumer Price Index (CPI) was 3.5 per cent, in February 2025; February 2025; The annual consumer price inflation as measured by the Consumer Price Index (CPI) was 3.5 per cent in February 2025

**Predicted source text:**

> 28th February, 2025  Highlights of <b>February 2025</b> Consumer Price Index (CPI) <b>Overall year-on-year (annual) inflation rate as measured by the Consumer Price Index (CPI) was 3.5 per cent, in February 2025</b>; an increase from an inflation rate of 3.3 per cent recorded in January 2025. The month-to-month inflation rate was 0.3 per cent in February 2025. The annual inflation was mainly due to an increase in prices of commodities under the following Classification of Individual Consumption ...
...
|---|---|
| **Golden answer** | 0.041 |
| **Predicted answer** | The annual consumer price inflation as measured by the Consumer Price Index (CPI) was 4.1 per cent in April 2025. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.000 | Semantic=0.313 | Fuzzy=8.1 | EvidenceMatch=False | Scoring=numeric_match
...
**Reasoning:** The question asks for Kenya's inflation rate in April 2025. The most relevant context is from Doc1 and Doc2, both published on 01 April 2025 and titled 'Kenya Consumer Price Indices and Inflation Rates Highlights April 2025' and 'Kenya Consumer Price Indices and Inflation Rates April 2025' respectively. Both documents provide the annual inflation rate for April 2025, which is 4.1 per cent. This directly answers the question. Doc3 provides core and non-core inflation rates, which are not directly relevant to the question about the overall inflation rate. The exact text passage from Doc1 is: 'Overall year-on-year (annual) inflation rate as measured by the Consumer Price Index (CPI) was 4.1 per cent, in April 2025; an increase from an inflation rate of 3.6 per cent recorded in March 2025.' The exact text passage from Doc2 is: 'The annual consumer price inflation as measured by the Consumer Price Index (CPI) was 4.1 per cent in April 2025.'

**Key phrases:** Overall year-on-year (annual) inflation rate as measured by the Consumer Price Index (CPI) was 4.1 per cent, in April 2025; The annual consumer price inflation as measured by the Consumer Price Index (CPI) was 4.1 per cent in April 2025.; The rate of core inflation was 2.5 per cent in April 2025.

**Predicted source text:**

> 30th April, 2025  Highlights of April 2025 Consumer Price Index (CPI) <b>Overall year-on-year (annual) inflation rate as measured by the Consumer Price Index (CPI) was 4.1 per cent, in April 2025</b>; an increase from an inflation rate of 3.6 per cent recorded in March 2025. The month-to-month inflation rate was 0.3 per cent in April 2025. The annual inflation was mainly due to an increase in prices of commodities under the following Classification of Individual Consumption by Purpose (COICOP) d...
...
**Reasoning:** The question asks for the headline inflation for December 2019. The first context document, titled 'Kenya Consumer Price Indices and Inflation Rates December 2019' and published on 01 December 2019, directly provides the answer. The relevant passage is 'The overall year on year inflation in December 2019 was 5.82 per cent.' This matches the question's requirements for the specific month and year.

**Key phrases:** Consumer Price Indices (CPI) and rates of inflation, for December, 2019; The overall year on year inflation in December 2019 was 5.82 per cent; Kenya Consumer Price Indices and Inflation Rates December 2019; Kenya Consumer Price Indices and Inflation Rates December 2019
...
|---|---|
| **Golden answer** | 3.7 |
| **Predicted answer** | Households have an average of 3.7 members. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.286 | Semantic=0.374 | Fuzzy=100.0 | EvidenceMatch=False | Scoring=numeric_match
...
**Reasoning:** The question asks for the average household size in Kenya according to the 2022 Kenya Demographic and Health Survey. The most relevant context is Doc1, which directly states 'Households have an average of 3.7 members.' This figure is from the 2022 survey, matching the year specified in the question. The other documents do not provide the average household size for 2022.

**Key phrases:** Households have an average of 3.7 members; Kenya Demographic and Health Survey 2022 Presentation; 2022; Kenya Household Master Sample Frame (KHMSF); Kenya Demographic and Health Survey 2022 Presentation; 2022; Percent distribution of households; Kenya Demographic and Health Survey 2022 Presentation; 2022

**Predicted source text:**

> Title: Kenya Demographic and Health Survey <b>2022</b> Presentation
...
No ITN46%At least 1 ITN for every 2 people in the household37%At least 1 ITN but not enough for all houehold members54%Full Household Coverage of ITNs<b>Percent distribution of households</b>
---
Title: Kenya Demographic and Health Survey <b>2022</b> Presentation
Release date: 01 January 2030
Page number: 32
...
**Reasoning:** The question asks for the predominant dwelling unit in Kenya as of 2024. The most recent publication available is from 2023/24. The context from Doc1 mentions that bungalows are the predominant type of dwelling units, making up 51.8 per cent of all units. However, the publication date is 01 January 2025, and the title is 2023 24 Kenya Housing Survey Basic Report1, which does not directly state the data for 2024. Therefore, the answer cannot be provided as the data is not for 2024.

**Key phrases:** predominant type of dwelling units; 51.8 per cent of all units; preferred type of rental units for tenants; most preferred type of dwelling unit among tenants; proportion of the dwelling units by type of durable and non-durable roof material
...
|---|---|
| **Golden answer** | 0.052 |
| **Predicted answer** | 5.2 percent |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.000 | Semantic=0.658 | Fuzzy=25.0 | EvidenceMatch=True | Scoring=numeric_match
...
**Reasoning:** The question asks for the proportion of adults who accessed informal-only financial services in 2024. The most relevant context is from the 2024 FinAccess Household Survey Report, which directly states that 'access to informal-only financial services increased to 5.2 percent in 2024'. This figure is the most direct and relevant answer to the question. The other contexts provide additional information about financial access and usage of informal channels, but do not directly answer the specific question about informal-only financial services. The highlighted phrases from the first context document are directly related to the question and provide the exact figure asked for. The highlighted phrases from the second and third context documents provide additional context about informal financial services but do not directly answer the question.

**Key phrases:** access to informal-only financial services increased to 5.2 percent in 2024; 2024 FinAccess Household Survey Report; 5.2 Informal; Informal financial service providers; Informal financial services usage was at 30.8 percent of the population in 2024

**Predicted source text:**

> providers. Overall, financial access has improved from 83.7 percent in 2021 to 84.8 percent in 2024. Similarly, the adult population that reported being completely excluded from accessing any form of financial services or products in the last 12 months has declined from 11.6 percent in 2021 to 9.9 percent in 2024. Notably, access to informal-only financial services increased to <b>5.2 percent</b> in 2024 from 4.7 percent in 2021. The usage and quality of financial services and products continue ...
...
|---|---|
| **Golden answer** | 0.398 |
| **Predicted answer** | The overall poverty rate increased slightly from 37.3 per cent in 2021 to 39.8 per cent in 2022, indicating that 20.2 million people lived below the absolute poverty line in 2022. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.000 | Semantic=0.186 | Fuzzy=6.4 | EvidenceMatch=False | Scoring=numeric_match
...
**Reasoning:** The question asks for the poverty rate in Kenya as of 2022. The most relevant information is found in Doc1 and Doc2, both titled 'The Kenya Poverty Report 2022' and published on 01 January 2024. Doc1 directly states that the overall poverty rate in 2022 was 39.8 per cent, which matches the question's requirement for the poverty rate in 2022. Doc2 also confirms this figure, stating that the overall poverty headcount rate for individuals was at 39.8 per cent in 2022. Doc3 provides additional context about household poverty rates but does not directly answer the question about the overall poverty rate. Therefore, the most accurate and direct answer is taken from Doc1.

**Key phrases:** The overall poverty rate increased slightly from 37.3 per cent in 2021 to 39.8 per cent in 2022, indicating that 20.2 million people lived below the absolute poverty line in 2022.; The overall poverty headcount rate for individuals was at 39.8 per cent in 2022, this implies that about 20.2 million individuals were unable to meet the overall poverty line threshold.; Estimating the overall poverty rate at the household level in 2022 suggests that about 3 in 10 households in Kenya are poor
...
|---|---|
| **Golden answer** | 0.649 |
| **Predicted answer** | 64.9 per cent of individuals used a mobile phone |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.000 | Semantic=0.298 | Fuzzy=11.3 | EvidenceMatch=False | Scoring=numeric_match
...
**Reasoning:** The question asks for the percentage of people in Kenya who used a mobile phone regardless of ownership status. The most relevant context is from Doc3, which states that 'Nationally, 64.9 per cent of individuals used a mobile phone'. This figure directly answers the question as it provides the percentage of mobile phone users in Kenya, regardless of ownership status. The context is from the 'Analytical Report on ICT based on the 2023/24 Kenya Housing Survey' published on 01 August 2025, which is the most recent and relevant publication for the year 2023/24.

**Key phrases:** 64.9 per cent of individuals used a mobile phone
...
**Reasoning:** The question asks for the percentage increase in petroleum product imports in 2024. The context from Doc1 and Doc3 directly provides the percentage increase in petroleum product imports for 2024, which is 20.9 per cent. The context from Doc2 does not provide any information on the percentage increase in petroleum product imports. The context from Doc1 and Doc3 are from the 2025 Economic Survey, which is the most recent publication and directly answers the question.

**Key phrases:** The quantity of imported petroleum products rose by 20.9 per cent from 4.3 million tonnes in 2023 to 5.2 million tonnes in 2024.; total domestic demand for petroleum products increased by 2.0 per cent to 5.2 million tonnes; The total petroleum imports rose by 20.9 per cent to 5.2 million tonnes
...
|---|---|
| **Golden answer** | 0.147 |
| **Predicted answer** | The number of international visitor arrivals increased by 14.7 per cent in 2024. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.000 | Semantic=0.159 | Fuzzy=7.1 | EvidenceMatch=True | Scoring=numeric_match
...
**Reasoning:** The question asks for the percentage increase in international visitor arrivals in 2024. The context provides the exact percentage increase of 14.7 per cent, which directly answers the question. The context also mentions the total number of international visitor arrivals, which is 2,394.4 thousand in 2024. The context is from the 2025 Economic Survey, which is the most recent publication available and relevant to the question.

**Key phrases:** Number of international visitor arrivals increased by 14.7 per cent to 2,394.4 thousand in 2024; Number of international arrivals increased by 14.7 per cent from 2,086.8 thousand in 2023 to 2,394.4 thousand in 2024; The number of international visitor arrivals in-creased by 14.7 per cent from 2,086.8 thousand in 2023 to 2,394.4 thousand in 2024

**Predicted source text:**

> by 11.8 per cent to 2,468.7 thousand in 2024.<b>Number of international visitor arrivals increased by 14.7 per cent to 2,394.4 thousand in 2024</b>. 11.8%14.7%12Domestic Economy
...
|---|---|
| **Golden answer** | 0.218 |
| **Predicted answer** | The agricultural sector accounted for 21.8 percent of Kenya’s GDP in 2023. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.000 | Semantic=0.155 | Fuzzy=12.7 | EvidenceMatch=True | Scoring=numeric_match
...
**Reasoning:** The question asks for the percentage of Kenya’s GDP that the agricultural sector accounted for in 2023. The most relevant context is from the National Agriculture Production Report 2024, which directly states that the agricultural sector accounted for 21.8 percent of Kenya’s GDP in 2023. This information is explicitly mentioned in both Doc1 and Doc2, making it the most reliable and direct answer to the question. The context from Doc3 and Doc4 are for 2024 and are not relevant to the question.

**Key phrases:** 21.8 percent of Gross Domestic Product (GDP) in 2023; 21.8 per cent of the Gross Domestic Product (GDP) in 2023

**Predicted source text:**

> 2024NATIONAL AGRICULTURE PRODUCTION REPORT xii.The agriculture sector continues to play a critical role in Kenya’s economy accounting for <b>21.8 percent of Gross Domestic Product (GDP) in 2023</b> and employs over 40 percent of the total population. Given the critical role that the sector plays in the Kenyan economy, it is increasingly important to ensure that high frequency quality data is available to support evidence-based decisions and policies, management of national food security, agricul...
...
**Reasoning:** The question asks for the area under food crops in 2023. The most relevant context is from Doc2, which directly states that 'The area under food crops increased from 4,935.3.1 thousand hectares in 2022 to 5,371.7 thousand hectares in 2023.' This directly answers the question with the specific figure for 2023. The other documents do not provide this specific information for 2023.

**Key phrases:** area under most crops; 2023; area under food crops; 5,371.7 thousand hectares; 2023; Sweet Potato; 2023
...
| **Predicted answer** | 4,285.2 thousand tonnes |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=1 | F1=1.000 | Semantic=1.000 | Fuzzy=100.0 | EvidenceMatch=True | Scoring=exact_match
...
**Reasoning:** The question asks for the amount of maize produced in 2023. The most relevant context is from the National Agriculture Production Report 2024, which directly states that 'Aggregate maize production increased by 38.8 per cent in 2023 to 4,285.2 thousand tonnes from 3,087.2 thousand tonnes in 2022.' This provides the exact figure for maize production in 2023. The context is from the National Agriculture Production Report 2024.

**Key phrases:** Maize; 2023; 4,285.2 thousand tonnes

**Predicted source text:**

> 2024NATIONAL AGRICULTURE PRODUCTION REPORT 9.3.1: <b>Maize</b>Maize is the most widely produced staple crop in Kenya, consumed by majority of households in both urban and rural areas. The area dedicated to maize cultivation increased from 2,113.5 thousand hectares in 2022 to 2,430.0 thousand hectares in <b>2023</b> (Table 3.2). The expansion was driven by favorable prices of maize in 2023. Aggregate maize production increased by 38.8 per cent in 2023 to <b>4,285.2 thousand tonnes</b> from 3,087....

<details><summary>Retrieved context chunks</summary>

```
2024NATIONAL AGRICULTURE PRODUCTION REPORT 9.3.1: <b>Maize</b>Maize is the most widely produced staple crop in Kenya, consumed by majority of households in both urban and rural areas. The area dedicated to maize cultivation increased from 2,113.5 thousand hectares in 2022 to 2,430.0 thousand hectares in <b>2023</b> (Table 3.2). The expansion was driven by favorable prices of maize in 2023. Aggregate maize production increased by 38.8 per cent in 2023 to <b>4,285.2 thousand tonnes</b> from 3,087.2 thousand tonnes in 2022. This increase in production was attributed to several factors, which include the government's subsidy of fertilizers, favorable weather conditions such as sufficient rainfall in 2023 and the expansion of the area under the crop. The value of Maize increased from KSh 179.7 billion in 2022 to KSh 180.8 billion in 2023. Table 3.3 shows the top 20 counties in production of Maize in 2023. Table 3.3: Top 20 Counties in Maize Production in 2023Table 3.2: Production and Value of Maize,
---
the top 20 counties in production of <b>Maize</b> in <b>2023</b>. Table 3.3: Top 20 Counties in Maize Production in 2023Table 3.2: Production and Value of Maize, 2019-2023Year20192020202120222023*Area (Ha)2,207,3252,171,6972,168,6032,113,5202,430,013Production (Tons)3,960,3853,795,1753,304,4303,087,2204,285,206Production (90 kg bag)44,004,27842,168,61136,715,88934,302,44447,613,398Total Value KSh (Billion)121.3126.3105.0179.7180.8Year20192020202120222023*CountyArea(Ha)TonsHaTonsHaTonsHaTonsHaTonsUasin Gishu100,081324,366106,999456,574104,645385,400102,820360,454117,923476,538Trans
---
...
| **Predicted answer** | 472,773 MT |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.000 | Semantic=0.545 | Fuzzy=32.3 | EvidenceMatch=False | Scoring=numeric_match
...
**Reasoning:** The question asks for the amount of sugar produced in 2023. The most relevant context is from Doc2 and Doc3, both titled 'Leading Economic Indicators May 2024' and 'Leading Economic Indicators June 2024' respectively, which provide a table of domestic production of sugar for the year 2023. The total production for 2023 is directly stated as 472,773 MT. This is the most directly relevant and recent figure available in the provided contexts.

**Key phrases:** 472,773; 472,773
...
| **Predicted answer** | Fish farming (aquaculture) recorded an increased production of 14 per cent to 31.7 thousand tonnes of 2023. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.316 | Semantic=0.310 | Fuzzy=100.0 | EvidenceMatch=False | Scoring=numeric_match
...
**Reasoning:** The question asks for the amount of fish produced by aquaculture in 2023. The context provides the exact figure of 31.7 thousand tonnes for 2023. The most relevant contexts are from the National Agriculture Production Report 2024, which directly mentions the production figures for 2023. The exact text passage from the pdf of where context has been gotten from is 'Fish farming (aquaculture) recorded an increased production of 14 per cent 31.7 Thousand tonnes of 2023 compared to 27.8 thousand tonnes in 2022.'

**Key phrases:** Fish farming (aquaculture) recorded an increased production of 14 per cent 31.7 Thousand tonnes of 2023; 31.7 Thousand tonnes of 2023; 2023; aquaculture production steadily rising from 18.5 thousand tonnes in 2019 to 31.7 thousand tonnes in 2023; 31.7 thousand tonnes in 2023; 2023; Fish farming (aquaculture) recorded an increased production of 14 per cent to 31.7 thousand tonnes of harvested in the year 2023; 31.7 thousand tonnes of harvested in the year 2023; 2023

**Predicted source text:**

> 7.2.Fish farming (aquaculture) recorded an increased production of 14 per cent 31.7 Thousand tonnes of <b>2023</b> compared to 27.8 thousand tonnes in 2022. cage culture continues to increase steadily accounting for about 73 per Figure 7.2: Inland water capture ﬁsheries and Aquaculture, 2022 and 2023.
...
**Reasoning:** The question asks for the number of births registered in Kenya in 2023. The most relevant document is the 2023 Kenya Vital Statistics Report, which provides the exact number of births registered in 2023. The number 1,192,884 is directly stated in the context, making it the most accurate answer. The context is from Doc3 published_date=01 May 2024 title=2024 Economic Survey.

**Key phrases:** 1,192,884 births were registered in 2023; 2023 Kenya Vital Statistics Report; 2023

**Predicted source text:**

> between 2019 and <b>2023</b>. The expected births in 2023 were 1,547,260. The registered number of births during the same year was 1,192,884, representing a coverage of 77.1 percent. Most of the births in 2023 (99%) were registered in a health facility. Table 4.1 further shows that more males than females new borns were registered.
...
| **Predicted answer** | A total of 1,557,370 births were expected in 2023. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.000 | Semantic=0.310 | Fuzzy=17.5 | EvidenceMatch=False | Scoring=numeric_match
...
**Reasoning:** The question asks for the number of births expected in 2023. The most relevant context is from Doc2, which is the 2024 Economic Survey. This document provides the expected number of births for 2023, which is 1,557,370. This number directly answers the question and is the most recent and relevant data available.

**Key phrases:** 1,557,370 expected births in 2023
...
|---|---|
| **Golden answer** | 0.089 |
| **Predicted answer** | The real estate sector has averaged at 8.9 per cent. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.000 | Semantic=0.357 | Fuzzy=7.0 | EvidenceMatch=False | Scoring=numeric_match
...
**Reasoning:** The question asks for the average share of Kenya's GDP contributed by the real estate sector according to the 2023/2024 Real Estate Survey. The most relevant context is from Doc1 and Doc3, both of which mention that the real estate sector has averaged at 8.9 per cent of the country’s Gross Domestic Product (GDP). This information directly answers the question and is supported by the exact text passage from the 2023/2024 Real Estate Survey Report_1.

**Key phrases:** The real estate sector is one of the most vibrant in Kenyan economy and has been registering exponential growth in the recent past as evidenced through its significant contribution to the country’s Gross Domestic Product (GDP) which has averaged at 8.9 per cent.; The real estate sector is one of the most vibrant in Kenyan economy and has been registering exponential growth in the recent past as evidenced through its significant contribution to the country’s Gross Domestic Product (GDP) which has averaged at 8.9 per cent.; The real estate sector is one of the most vibrant in Kenyan economy and has been registering exponential growth in the recent past as evidenced through its significant contribution to the country’s Gross Domestic Product (GDP) which has averaged at 8.9 per cent.
...
2023/2024Survey ReportREAL ESTATE11The sector’s real output grew from 6.7 per cent to 7.3 per cent over the same period. The growth in the sector has been supported by infrastructural development such as roads, utility connections, rapid urbanization, better returns on investment in the sector and several government initiatives towards affordable housing.*Economic Survey<b>The real estate sector is one of t...
...
2023/2024Survey ReportREAL ESTATE11The sector’s real output grew from 6.7 per cent to 7.3 per cent over the same period. The growth in the sector has been supported by infrastructural development such as roads, utility connections, rapid urbanization, better returns on investment in the sector and several government initiatives towards affordable housing.*Economic Survey<b>The real estate sector is one of the most vibrant in Kenyan economy and has been registering exponential growth in the recent past as evidenced through its significant contribution to the country’s Gross Domestic Product (GDP) which has averaged at 8.9 per cent.</b>
---
...
---
a significant proportion of urban and peri-urban household expenditures. Commercia
```
...
|---|---|
| **Golden answer** | 0.951 |
| **Predicted answer** | 95.1 per cent of real estate firms that took part in the survey were private businesses |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.000 | Semantic=0.231 | Fuzzy=6.5 | EvidenceMatch=False | Scoring=numeric_match
...
**Reasoning:** The question asks for the percentage of real estate firms that are private businesses. The most relevant context is from the 2023/24 Real Estate Survey Report, which directly states that '95.1 per cent of real estate firms that took part in the survey were private businesses'. This figure is the most directly relevant to the question and is taken from a report whose title contains the period the question asks about.

**Key phrases:** 95.1 per cent were private businesses; real estate firms that took part in the survey; private businesses; real estate sector is dominated by private sector players; real estate firms; private sector players; real estate firms; private limited companies; real estate firms

**Predicted source text:**

> 20Where Your Future Begins95.13.41.5Chapter 033.1 Types of <b>Real Estate Firms</b>The real estate sector is dominated by <b>private sector players</b>. Out of the <b>real estate firms that took part in the survey</b>, 95.1 per cent were <b>private businesses</b> while 3.4 per cent and 1.5 per cent were cooperatives and parastatals, respectively (Figure 3.1). 	 Majority (95.1%) of real estate firms that took part in the survey were private businesses while 3.4 per cent and 1.5 per cent were coop...
...
---
2023/2024Survey ReportREAL ESTATE21The real estate sector is dominated by <b>private sector players</b>.3.2 Legal Status of <b>Real Estate Firms</b>The survey sought to establish the legal status of firms engaged in real estate activities. The results presented in Figure 3.2 indicate that 84.9 per cent of real estate firms is registered as local <b>private limited companies</b>, 4.0 per cent are registered as sole proprietors and 4.5 per cent are registered as local public limited companies. Real estate companies registered as partnerships were 5.0 per cent while 1.5 per cent of firms are registered as foreign private limited companies.Figure 3.2: Distribution of Real Estate Firms by Legal Status (%) 84.95.04.54.01.5Local Private LimitedCompanyPartnershipLocal Public LimitedCompanySole ProprietorshipForeign PrivateLimited CompanyRegistration with professional and regulatory institutions enhances professionalism, discipline and consumer protection among pla
```
...
|---|---|
| **Golden answer** | 0.667 |
| **Predicted answer** | 66.7% of all available properties in 2023 were in Nairobi City County. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.000 | Semantic=0.324 | Fuzzy=11.1 | EvidenceMatch=False | Scoring=numeric_match
...
**Reasoning:** The question asks for the percentage of available properties in Nairobi City County in 2023. The most relevant context is from the 2023 24 Real Estate Survey Report_1, which directly states that 'Nairobi City County dominated the market, accounting for 66.7% of all available properties.' This figure is also confirmed in the second context document, which specifies that '66.7 per cent of properties in the market in 2023 were in Nairobi City County.' The most recent publication is the 2023 24 Real Estate Survey Report_1, which is the most relevant to the question.

**Key phrases:** Nairobi City County dominated the market, accounting for 66.7% of all available properties.; 66.7 per cent of properties in the market in 2023 were in Nairobi City County
...
|---|---|
| **Golden answer** | 0.233 |
| **Predicted answer** | 23.3 per cent of residential properties in the market were three-bedroom flats/apartments. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.000 | Semantic=0.300 | Fuzzy=6.3 | EvidenceMatch=False | Scoring=numeric_match
...
**Reasoning:** The question asks for the percentage of residential properties on offer for sale that were three-bedroom flats. The context from the 2023/24 Real Estate Survey Report_1 directly states that 23.3 per cent of residential properties in the market were three-bedroom flats/apartments. This information is explicitly mentioned in both Doc1 and Doc2, making it the most relevant and direct answer to the question. The context is from page 27 of the 2023/24 Real Estate Survey Report_1 published on 01 January 2025.

**Key phrases:** 23.3 per cent of residential properties in the market were three-bedroom flats/apartments; 23.3 per cent of residential properties in the market were three-bedroom flats/apartments
...
2023/2024Survey ReportREAL ESTATE27The survey findings indicate that <b>23.3 per cent of residential properties in the market were three-bedroom flats/apartments</b>.4.2.2	 Location of residential properties on offer for sale Survey findings indicate that 66.7 per cent of properties in the market in 2023 were in Nairobi City County, 11.0 per cent were in Kiambu County and 10.7 per cent in Mombasa. The remai...
...
|---|---|
| **Golden answer** | 0.762 |
| **Predicted answer** | 76.2 per cent of all the properties that were on offer for sale in 2023 ended up being sold during the year. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.000 | Semantic=0.375 | Fuzzy=7.3 | EvidenceMatch=False | Scoring=numeric_match
...
**Reasoning:** The question asks for the percentage of residential properties sold in 2023. The most relevant information is found in Doc2 and Doc3, which both state that 76.2 per cent of all the properties that were on offer for sale in 2023 ended up being sold during the year. This figure directly answers the question and is supported by the context provided in the documents. The context from Doc1 and Doc4 do not provide a direct answer to the question as they focus on specific regions and types of properties rather than the overall market. Doc5 is not relevant as it discusses properties for lease, not sale.

**Key phrases:** proportion of residential properties that were advertised and sold in 2023 by region; 86.2 per cent of residential properties that were advertised in 2023 Kiambu were sold within the same year; proportion of residential properties that were advertised and sold in 2023 by type; 76.2 per cent of all the properties that were on offer for sale in 2023 ended up being sold during the year; proportion of residential properties advertised and sold in 2023; 76.2 per cent of all the properties that were on offer for sale in 2023 ended up being sold during the year

**Predicted source text:**

> 2023/2024Survey ReportREAL ESTATE33Table 4.5 shows the <b>proportion of residential properties that were advertised and sold in 2023 by region</b>. The findings show that <b>86.2 per cent of residential properties that were advertised in 2023 Kiambu were sold within the same year</b>. Mombasa recorded the least proportion (55.6%) of properties that were advertised and sold during the year. All the two-bedroom bungalows in the Nairobi regions that were advertised were sold during the year. All th...
...
**Reasoning:** The question asks for the total recorded employment in Kenya in 2022. None of the provided documents contain data for the year 2022. The most recent data available is from 2017, as seen in Doc5. Therefore, it is not possible to provide an answer based on the given contexts.

**Key phrases:** 2011 Economic Survey; 2016 Economic Survey; 2018 Economic Survey
...
**Reasoning:** The question asks for the national overall poverty headcount rate for individuals in 2022. The most relevant context is from Doc1 and Doc3, both of which mention the overall poverty headcount rate for 2022. Doc3 provides the most direct and specific information, stating that the national overall poverty headcount rate for individuals was 39.8 per cent in 2022. This matches the question's requirements exactly. Doc1 also mentions 39.8 per cent but does not provide the exact year in the text. Therefore, Doc3 is the most relevant source.

**Key phrases:** Nationally, the overall poverty headcount rate1 for individuals was at 39.8 per cent, meaning that nearly 20 million people could not meet their basic food and non-food needs.; Nationally the overall poverty headcount rate for individuals was at 39.8 per cent in 2022, this implies that about 20.2 million individuals were unable to meet the overall poverty line threshold.
...
|---|---|
| **Golden answer** | 0.275 |
| **Predicted answer** | Nairobi City contributed a disproportionately large share (27.5%) of the national GVA. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.000 | Semantic=0.093 | Fuzzy=6.6 | EvidenceMatch=False | Scoring=numeric_match
...
**Reasoning:** The question asks for Nairobi City’s five-year average share of national GVA (2019–2023). The most relevant context is from Doc1, which directly states that Nairobi City contributed a disproportionately large share (27.5%) of the national GVA. This figure is from the five-year average period (2019-2023) as mentioned in the context. The other documents do not provide the specific information required for the question. The exact text passage from the pdf of where context has been gotten from is: 'The report highlights several key points about the disparities across the county economies:I. Significant Economic Disparities: There are considerable differences in the size of county economies, with Nairobi City standing out by contributing a disproportionately large share (27.5%) of the national GVA. Other counties like Kiambu, Nakuru, and Mombasa also have notable contributions of 5.6 per cent, 5.2 per cent and 4.8 per cent, respectively. However, majority of the counties (33) contributed less than 2.0 per cent'

**Key phrases:** Nairobi City; 27.5%; national GVA; Nairobi City; manufacturing GVA; Nairobi City; secondary sector activities

**Predicted source text:**

> GVA ContributionThis part provides an analysis of the counties’ contribution to the total GVA and to the key sectors of the economy, namely, agriculture, forestry, and fishing; manufacturing; <b>secondary sector activities</b> (including construction); and services. The analysis uses a five-year average (2019-2023) to account for any shocks that may have disproportionately impacted certain counties, thereby reducing the potential distortion.3.1 Contribution to Gross Value AddedThe report highlig...

<details><summary>Retrieved context chunks</summary>

```
GVA ContributionThis part provides an analysis of the counties’ contribution to the total GVA and to the key sectors of the economy, namely, agriculture, forestry, and fishing; manufacturing; <b>secondary sector activities</b> (including construction); and services. The analysis uses a five-year average (2019-2023) to account for any shocks that may have disproportionately impacted certain counties, thereby reducing the potential distortion.3.1 Contribution to Gross Value AddedThe report highlights several key points about the disparities across the county economies:I.	Significant Economic Disparities: There are considerable differences in the size of county economies, with <b>Nairobi City</b> standing out by contributing a disproportionately large share (<b>27.5%</b>) of the <b>national GVA</b>. Other counties like Kiambu, Nakuru, and Mombasa also have notable contributions of 5.6 per cent, 5.2 per cent and 4.8 per cent, respectively. However, majority of the counties (33) contributed less than 2.0 per cent
---
heavily dependent on agricultur-al production, particularly those growing tea, maize, potatoes, and vegetables, contribute more significantly to the <b>national GVA</b> than those focusing on less economically impactful activi-ties. Contribution to Gross Value AddedFive-year Average Analysis 031733%Contribution of <b>Nairobi City</b> to secondary economic activities during the period under review (2019-2023), primarily supported by construction and electricity supply activities. Counties like Nakuru and Embu, which are involved in electricity generation, showed higher GVA in these sectors compared to other counties. <b>27.5%</b>Nairobi City ‘s contribution contributing to the national GVA. Other counties like Kiambu, Nakuru, and Mombasa also have notable contributions of 5.6 per cent, 5.2 per cent and 4.8 per cent, respectively. However, majority of the counties (33) contributed less than 2.0 per cent each to the national GVA.
---
sectors compared to other c
```
...
| **Predicted answer** | 24 percent of children under age five have a birth certificate. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.167 | Semantic=0.335 | Fuzzy=82.4 | EvidenceMatch=False | Scoring=none
...
**Reasoning:** The question asks for the percentage of children in Kenya who have a birth certificate. The most relevant context is from the 2008 Kenya Demographic and Health Survey, which directly states that 'close to one-quarter (24 percent) have a birth certificate.' This figure is specific to children under age five, which matches the demographic mentioned in the question. The context from Doc2 is the most relevant as it directly answers the question and provides the exact percentage. The other documents do not provide a direct answer to the question as asked.

**Key phrases:** 24 percent of children under age five have a birth certificate.; 24 percent of children under age five have a birth certificate.
...
|---|---|
| **Golden answer** | 0.451 |
| **Predicted answer** | The national death registration completeness in 2023 was 45.1 percent. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.000 | Semantic=0.381 | Fuzzy=10.7 | EvidenceMatch=True | Scoring=numeric_match
...
**Reasoning:** The question asks for the national death registration completeness in 2023. The most relevant context is from the 2023 Kenya Vital Statistics Report, which directly states that 'Death registration completeness declined from 47.6 in 2022 to 45.1 in 2023.' This provides the exact figure for 2023, which is 45.1 percent. The other documents either do not provide data for 2023 or do not directly answer the question. The 2024 report mentions a decline from 45.1 percent to 44.8 percent, but this is for the period between 2023 and 2024, not specifically for 2023. The third document provides a definition and methodology for death registration completeness, but does not provide the specific figure for 2023.

**Key phrases:** Death registration completeness declined from 47.6 in 2022 to 45.1 in 2023; 2023 Kenya Vital Statistics Report; death registration completeness declined from 45.1 per cent to 44.8 per cent; Death registration completeness is the proportion of expected deaths that have been registered in a Civil Registration System
...
**Reasoning:** The question asks for the proportion of registered deaths that occurred in health facilities in 2023. The most recent publication that mentions this is the 2025 Economic Survey, which states that the proportion of registered deaths in health facilities was 54.9 per cent in 2024. However, this does not provide the data for 2023. The 2023 Economic Survey mentions the proportion of registered deaths in health facilities for 2022, which was 53.0 per cent. However, this does not provide the data for 2023. The 2022 Economic Survey mentions the proportion of registered deaths in health facilities for 2021, which was 52.5 per cent. However, this does not provide the data for 2023. The Kenya Vital Statistics Report 2024 mentions the proportion of registered deaths in health facilities for 2023 and 2024, which was 54.9 per cent in both years. However, this does not provide the data for 2023. Therefore, the answer cannot be provided.

**Key phrases:** registered deaths reported to have occurred in health facilities; 54.9 per cent; registered deaths in health facilities; 53.0 per cent; registered deaths in health facilities; 53.0 per cent

**Predicted source text:**

> total number of registered deaths increased from 205,731 in 2023 to 206,417 in 2024. In 2024, deaths that occurred at health facilities were 113,379, accounting for <b>54.9 per cent</b> of the total registered deaths.Source: Civil Registration Services		*Provisional				1Community Death Registration are those that occur outside the health facilities16.35. Details of registered deaths by sex for the period 2020 to 2024 are shown in Table 16.21. More male (55.8 %) than female (44.2 %) deaths were r...
...
---
Economic Survey 2023PAGE 37616.27. Table 16.17 shows registration of deaths by place of occurrence for the period 2018 to 2022. The total number of registered deaths decreased by 8.1 per cent from 231,944 in 2021 to 213,210 in 2022. The proportion of <b>registered deaths in health facilities</b> increased marginally from 52.5 per cent in 2021 to <b>53.0 per cent</b> in 2022. Conversely, proportion of registered deaths in the community decreased from 47.5 per cent in 2021 to 47.0 per cent in 2022.16.28. Registration of deaths by sex for the period 2018 to 2022 is shown in Table 16.18. The number of deaths registered for males decreased from 131,599 in 2021 to 120,357 in 2022 while that of females decreased from 100,345 in 2021 to 92,853 in 2022. During the year under review, a higher proportion of male deaths (56.4%) than female deaths (43.6%) were registered.16.29. Table 16.19 shows registered deaths by sex and age. In 2022, the number of registered deaths was high among males compared to females
---
deaths registration cover-age rate declined by 80.6 per cent and 47.6 per cent in 2022 respectively. The proportion of regis-tered births and deaths reported to have occurred in health facilities increased to 99.0 per cent and <b>53.0 per cent</b>, respectively, during the review pe-riod. Gov
```
...
**Error:** `500 Server Error: Internal Server Error for url: http://127.0.0.1:8001/search?q=What+is+the+most+common+Household+durable+good+in+Kenya%3F&content_type=all&debug=true`
...
**Error:** `500 Server Error: Internal Server Error for url: http://127.0.0.1:8001/search?q=In+which+Kenyan+county+is+the+percentage+of+adolescent+women+age+15-19+who+have+ever+been+pregnant+highest%3F&content_type=all&debug=true`
...
|---|---|
| **Golden answer** | 0.15 |
| **Predicted answer** | In Kenya, 15% of adolescent women age 15-19 have ever been pregnant. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.000 | Semantic=0.258 | Fuzzy=5.6 | EvidenceMatch=True | Scoring=numeric_match
...
**Reasoning:** The question asks for the percentage of adolescent women in Kenya who have been pregnant. The most recent and relevant data is from the Kenya Demographic and Health Survey 2022. The context provides the exact percentage of adolescent women age 15-19 who have ever been pregnant, which is 15%. This information is directly quoted from the summary report and the main report volume 1 of the Kenya Demographic and Health Survey 2022. The context from Doc1 and Doc2 both provide the same percentage of 15% for adolescent women age 15-19 who have ever been pregnant. The context from Doc3 provides additional information on the percentage of women who have ever been pregnant by age, education, and wealth quintile, but the headline figure of 15% is consistent across the documents.

**Key phrases:** In Kenya, 15% of adolescent women age 15-19 have ever been pregnant; 12% have given birth, 1% have had a pregnancy loss, and 3% are pregnant with their first child; Fifteen percent of women age 15–19 have ever been pregnant; About 4 in 10 women age 15–19 who have no education have ever been pregnant, as compared with only 5% of women who have more than secondary education

**Predicted source text:**

> in the highest wealth quintile.In Kenya, approximately half of women age 25-49 give birth for the first time before age 21, with the median age at 20.7. On average, urban women give birth for the first time two years later than rural women (22.0 years versus 19.9 years).Teenage Pregnancy<b>In Kenya, 15% of adolescent women age 15-19 have ever been pregnant</b>: <b>12% have given birth, 1% have had a pregnancy loss, and 3% are pregnant with their first child</b>. By county, teen pregnancy ranges ...
...
---
Fertility  •  157 years) and Nyeri (21.6 years); while those with the lowest median age at first birth are Migori (17.9 years), Homa Bay (18.4 years), Kisumu (18.9 years) and Siaya (18.9 years) (Table 5.11C). 5.8 TEENAGE PREGNANCY Teenage pregnancy Percentage of women age 15–19 who have ever been pregnant. Sample: Wo
```
...
| **Predicted answer** | Mandera County has the lowest percentage of women using modern family planning methods at 2% |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.133 | Semantic=0.369 | Fuzzy=100.0 | EvidenceMatch=False | Scoring=text_match
...
**Reasoning:** The question asks for the Kenyan county with the lowest percentage of women using modern family planning methods. The most recent publication, Kenya Demographic and Health Survey KDHS 2022 Summary Report, provides the relevant data. The text explicitly states that 'The counties with the lowest modern family planning use are Mandera (2%), Wajir (3%), Marsabit (6%), and Garissa (11%)'. Therefore, Mandera County has the lowest percentage of women using modern family planning methods at 2%. The context is from Doc3 published_date=01 January 2030 title=Kenya Demographic and Health Survey KDHS 2022 Summary Report.

**Key phrases:** Mandera and Wajir (2 percent each); modern family planning methods; Mandera County to 89% in Embu County; modern family planning methods; Mandera (2%); modern family planning methods

**Predicted source text:**

> Family Planning  •  95 Twenty-two counties have a CPR above the national average (58 percent). Approximately three-quarters of currently married women use a contraceptive method in Kirinyaga (81 percent), Makueni (80 percent), Meru (78 percent), Machakos (76 percent), and Tharaka-Nithi and Kiambu (74 percent each). The counties with the lowest CPR include <b>Mandera and Wajir (2 percent each)</b>, Garissa (6 percent), Turkana (10 percent), and Marsabit (12 percent) (Table 7.4C). Table 7.4C  Curr...
...
|---|---|
| **Golden answer** | Embu |
| **Predicted answer** | Embu County had the highest demand satisfied by modern methods for family planning at 89%. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.133 | Semantic=0.367 | Fuzzy=100.0 | EvidenceMatch=True | Scoring=text_match
...
**Reasoning:** The question asks for the number of people aged 5 years and above with a disability in Kenya according to the 2019 population census. None of the provided contexts contain information specifically about the 2019 population census or the number of people aged 5 years and above with a disability. The contexts discuss registered refugees and asylum seekers, registered Persons with Disabilities (PWDs), and convicted persons committed to prison by age and sex, but these do not directly address the question about the 2019 population census and disability statistics. Therefore, an answer cannot be provided based on the given contexts.

**Key phrases:** registered refugees and asylum seekers in Kenya by age and sex from 2016 to 2020; refugees and asylum seekers in 2020; population of refugees and asylum seekers; registered PWDs by sex and type of disability; total number of registered Persons with Disabilities; Persons with Disabilities; convicted persons committed to prison by age and sex, 2016-2020; convicted child prisoners (under 18 years); young-adult-prisoners of college age (18-25 years)

**Predicted source text:**

> Chapter  17: Governance, Peace and Security353Persons with Dis­abilities17.37. Disability refers to a person’s lack or diminished capacity to perform on their own, one or more of daily activities considered necessary for ordinary life of a human being such as moving around, com­municating, feeding, bathing and dressing. Persons with such functional limitations owing to a health condition are deemed to be <b>Persons with Disabilities</b> (PWDs). However, identifying PWDs from the population depen...

<details><summary>Retrieved context chunks</summary>

```
Chapter  17: Governance, Peace and Security353Persons with Dis­abilities17.37. Disability refers to a person’s lack or diminished capacity to perform on their own, one or more of daily activities considered necessary for ordinary life of a human being such as moving around, com­municating, feeding, bathing and dressing. Persons with such functional limitations owing to a health condition are deemed to be <b>Persons with Disabilities</b> (PWDs). However, identifying PWDs from the population depends on the method and criteria applied. Data presented in this section is based on the medical model premised on the International Classification of Function (ICF 2001, WHO). 17.38. The Persons Living with Disability Act No. 14 of 2003 mandates the National Council for Per­sons with Disability vide section 7, Sub section 1(c) to register PWDs in Kenya. The following forms of disabilities are recognized; visual, hearing, physical, mental, albinism, autism, cerebral pulse and epi­lepsy. The registration
---
...
---
3,297       Epileps y1,705          1,307          3,012          1,758          1,215          2,973          1,136          803             1,939          1,351          965             2,316          947             777             1,724       Sub total3,520          2,852          6,372          3,775
```
...
| **Predicted answer** | Nairobi County has the highest access through formal providers. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.000 | Semantic=0.245 | Fuzzy=11.6 | EvidenceMatch=False | Scoring=none
...
**Reasoning:** The question asks for the Kenyan county that leads by formal financial inclusion. The most relevant context is from the 2021 FinAccess Household Survey, which directly states that 'Nairobi County has the highest access through formal providers'. This information is directly related to the question and provides a clear answer. The other contexts do not provide a direct answer to the question but do mention formal financial inclusion, which is relevant to the question.

**Key phrases:** Nairobi County has the highest access through formal providers; formal financial inclusion; formal providers; financial inclusion landscape; formal financial inclusion; financial inclusion across all the forty-seven (47) counties; formal financial inclusivity; formal financial services; formal financial inclusion

**Predicted source text:**

> 202021 FINACCESS HOUSEHOLD SURVEY472221201413121632183127302829463644332511070403022324103739382641434245351715060508093419There are significant differences in how residents of different Counties in Kenya access financial services and products. Nairobi County has the highest access through <b>formal providers</b> while West Pokot County had the lowest access to formal channels. In terms of informality; West Pokot, Turkana, and Samburu counties top the list of those counties relying on informal c...
...
| **Predicted answer** | Kenya’s population was projected to be 52.4 million in 2024. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.333 | Semantic=0.581 | Fuzzy=100.0 | EvidenceMatch=False | Scoring=numeric_match
...
**Reasoning:** The question asks for Kenya's estimated population in 2024. The most relevant context is from Doc2, which is titled 'Kenya Vital Statistics Report 2024' and published on 01 June 2025. This document provides a direct estimate of Kenya's population for 2024, stating that 'the population of Kenya in 2024, which was projected to be 52.4 million'. This matches the year specified in the question and provides a direct answer. The other documents do not contain relevant information for the year 2024.

**Key phrases:** 52.4 million; 2024
...
---
Title: Kenya Vital Statistics Report <b>2024</b>
Release date: 01 June 2025
Page number: 33

9.KENYA VITAL STATISTICS REPORT 2024Table 1.2: Projected Population of Selected Age Groups, 2020-2045Figure 1.6: Population Pyramid of Kenya, 2024Selected Age-group202020242030203520402045Total population (million)48.852.457.862.266.370.2Young persons- 15-24 (million)10.410.911.611.912.112.3Childre
```
...
**Reasoning:** The question asks for the growth rate of GDP at constant prices in Kenya in 2024. The most relevant context is from Doc2, which directly states that 'In 2024, Kenya’s real Gross Domestic Product (GDP) grew by 4.7 per cent'. This matches the question's requirement for the growth rate of GDP at constant prices in 2024. The other documents do not provide a direct answer to the question but are relevant to the topic of GDP growth rates.

**Key phrases:** Quarterly GDP growth rate, 2020 - 2024; In 2024, Kenya’s real Gross Domestic Product (GDP) grew by 4.7 per cent; 4.7%; Growth rates of Gross Domestic Product, 2020 - 2024
...
KENYA FACTS AND FIGURES 202513Figure 2: <b>Quarterly GDP growth rate, 2020 - 2024</b>			4.6-4.1-3.62.02.410.39.48.65.94.94.64.15.55.66.05.14.94.64.25.1-6.0-4.0-2.00.02.04.06.08.010.012.0Qrt1 Qrt2 Qrt3 Qrt4 Qrt1 Qrt2 Qrt3 Qrt4 Qrt1 Qrt2 Qrt3 Qrt4 Qrt1 Qrt2 Qrt3 Qrt4 Qrt1 Qrt2 Qrt3 Qrt420202021202220232024
...
KENYA FACTS AND FIGURES 20253111<b>In 2024, Kenya’s real Gross Domestic Product (GDP) grew by 4.7 per cent</b> compared to a revised growth of 5.7 per cent in 2023.<b>4.7%</b>
---
Service Activities-19.518.97.13.64.1Activities of households as employers;1.51.51.51.51.5FISIM-1.85.30.22.79.0All industries at basic prices0.57.24.76.04.8Taxes on products Less subsidies on Production-8.011.96.73.24.4GDP at market prices-0.37.64.95.74.7Table 6:  <b>Growth rates of Gross Domestic Product, 2020 - 2024</b>Economic Performance
---
...
| **Predicted answer** | The total wage employment in Kenya's modern sector in 2024 was 3,213.8 thousand. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.286 | Semantic=0.498 | Fuzzy=60.9 | EvidenceMatch=False | Scoring=numeric_match
...
**Reasoning:** The question asks for the total wage employment in Kenya's modern sector in 2024. The most relevant context is from Doc2, which provides a table titled 'Wage Employment in Modern Sector, 2020 - 2024'. The table includes data for the year 2024, with the total wage employment in the modern sector listed as 3,213.8 thousand. This directly answers the question. The date in the question is 2024 and the publication date is 01 May 2025 which is close to the question date.

**Key phrases:** Wage Employment in Modern Sector, 2020 - 2024; 2024*; 3,213.8
...
KENYA FACTS AND FIGURES 202539The nominal wage bill rose by 7.2 per cent to KSh 2,998.8 billion in 2024 with the private sector accounting for 70.6 per cent of the total nominal wage bill.7.2%
---
18Table 9: <b>Wage Employment in Modern Sector, 2020 - 2024</b>	Table 10: Wage Employment in the Public Sector, 2020 - 2024Number `000Sector2020202120222023<b>2024*</b>Public 884.7  923.0  937.8  992.9  1,023.2 Private 1,858.0  1,983.0  2,077.5  2,145.5  2,190.6 Total 2,742.6  2,906.1  3,015.4  3,138.5  <b>3,213.8</b>Number `000Entity20202021202220232024*Ministries and other exra-budgetary institutions1 206.1  220.7  226.0  233.6  236.7 Teachers Service Commission 331.1  349.9  348.6  390.4  410.7 Parastatal bodies2 95.7  96.7  97.8  98.9  100.1 Corporations controlled by the Government3 47.1  47.5  48.1  48.6  49.2 County Governments  204.6  208.1  217.3  221.4  226.5 Total 884.7  923.0  937.8  992.9  1,023.2 1 Includes employees of Judiciary and Parliament. 			2  Refers to Government wholly-owned corporations.			3  Refers to institutions where the Government has over 50 per cent shares but does not wholly own them.Employment, Earnings and Consumer Price Indices
---
...
**Reasoning:** The question asks for the number of people employed by the Teachers Service Commission in 2024. The most recent publication that mentions the Teachers Service Commission is the 2025 Economic Survey, which provides data on wage employment in the public sector by type of employer from 2020 to 2024. However, the document does not provide a specific number of employees for the Teachers Service Commission in 2024. The 2023 Statistical Abstract does not contain data for 2024. The 2024 National School Census Pilot Report does not provide data for the Teachers Service Commission. Therefore, an answer cannot be provided based on the given contexts.

**Key phrases:** Teachers Service Commission; 2022; Teachers Service Commission; 2024; Teachers Service Commission; 2024

**Predicted source text:**

> ..  17,094  16,416    Untrained Teachers      213  226  -  -  -  -  -      Total       310,027  316,855  331,062  341,217  331,232  359,816  362,918 Source: Ministry of Education, <b>Teachers Service Commission</b> and Technical Vocational Education and Training Authority* Provisional... Data not available1 Includes secondary schools and teacher training colleges Table 15.3: Teachers in Service by Type of School, 2016 - <b>2022</b>
...
**Reasoning:** The question asks for the number of holiday and business visitors in 2024. The provided contexts do not contain data for 2024. The most recent data available is for 2022. Therefore, an answer cannot be provided based on the given contexts.

**Key phrases:** Visitor Statistics; Visitor Categories; Holiday/ Business Visitors; Holiday/ Business Visitors; 2015-2022; Visitor Arrivals by Purpose; Length of Stay; Holiday; Business

**Predicted source text:**

> Statistical Abstract 2023  I  PAGE 31512Tourism<b>Visitor Statistics</b>: Data on visitors to Kenya, as re-corded by the Immigration Service under the Kenya Citizenship and Immigration Act of 2011, provides insights into the inflow and outflow of people. This data, captured by the PISCES system, includes the number of arrivals, departures, and the purpose of visits.<b>Visitor Categories</b>:In-transit Pass: For those passing through Kenya, valid for up to one week. Not required for direct transi...

<details><summary>Retrieved context chunks</summary>

```
Statistical Abstract 2023  I  PAGE 31512Tourism<b>Visitor Statistics</b>: Data on visitors to Kenya, as re-corded by the Immigration Service under the Kenya Citizenship and Immigration Act of 2011, provides insights into the inflow and outflow of people. This data, captured by the PISCES system, includes the number of arrivals, departures, and the purpose of visits.<b>Visitor Categories</b>:In-transit Pass: For those passing through Kenya, valid for up to one week. Not required for direct transits, aircraft crews, or cruise ship day visitors.Visitor’s Pass: Valid for up to six months with possible extensions to twelve months, catering to <b>business</b> pro-fessionals and tourists.Special Pass: Valid for up to three months.<b>Length of Stay</b>: Measured from arrival to departure, the length of stay statistics may underrepresent the actual time spent by visitors due to multiple visits by individuals.Hotel Occupancy Statistics are classified across major zones and their subdivisions:Nairobi: Divided into ‘High
---
Statistical Abstract 2023  I  PAGE 316Table 12.1: Reported <b>Visitor Arrivals by Purpose</b>,  2015- 2022			Table 12.2: Reported Visitor Departures by Purpose,  2015 - 2022			Table 12.3: Reported Visitor Arrivals and Departures by Mode of Travel, 2015 - 2022	Purpose20152016201720182019202020212022*<b>Holiday</b>/ <b>Business</b> Visitors                1,239,439  1,420,794  1,462,496  1,754,874  1,562,170  305,924  529,937  979,747 Visitors in Transit  82,049  88,924  104,779  97,075  172,869  37,172  47,992  75,803 Other Visitors            137,978  156,329  211,150  175,774  300,402  236,464  293,375  485,428 Total             1,459,4661,666,0471,778,4252,027,7232,035,441579,560871,3041,540,978Source: Directorate of Immigration Services* ProvisionalPurpose20152016201720182019202020212022*Holiday/Business Visitors          1,153,1431,318,2761,337,4621,607,2211,493,604179,407554,012816,069Visitors in Transit  77,72090,235115,83888,587149,28620,09240,34161,
```
...
**Reasoning:** The question asks for Kenya's total visitor arrivals in 2024. None of the provided contexts contain information related to visitor arrivals or tourism statistics. The contexts are focused on staff establishment, organizational information, and labour force statistics, which are not relevant to the question. Therefore, no answer can be provided.

**Key phrases:** 2024 Statistical Abstract Kisumu County; KENYA NATIONAL BUREAU OF STATISTICS; 2019 KPHC Volume 41
...
| **Predicted answer** | 2,313,985.3 tonnes |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=1 | F1=1.000 | Semantic=1.000 | Fuzzy=100.0 | EvidenceMatch=False | Scoring=exact_match
...
**Reasoning:** The question asks for the quantity of unmilled wheat imported by Kenya in 2024. The most relevant context is from the 2025 Statistical Abstract, which provides data on the quantities of principal commodities of import from 2016 to 2024. The table specifically lists 'Wheat, unmilled' with the quantity for 2024 as 2,313,985.3 tonnes. This directly answers the question. The other documents do not contain relevant information for the year 2024 or the specific commodity of unmilled wheat.

**Key phrases:** 2,313,985.3; 2024; Wheat, unmilled

**Predicted source text:**

> Domestic Imports15,03715,31016,827 15,355  15,819  16,294  16,170  15,152  15,782  11,984 Source:  Kenya Ports Authority*  ProvisionalTable 13.17a:	Principal Commodities Shipped1, 2017-<b>2024</b>‘000 Tonnes20172018201920202021202220232024*ImportsGeneral Cargo:Sugar1085376363682516683936Rice628535198626521277604159Plastic5725472594989061225687M/Vehicle & Lorries534322233317517249196181Fertilizer (in bags)1128670130120485257Iron & Steel16331,5981,8292,0732,4721,8951,6782,135Vehicle Tyres & Spares...
...
---
564  8,612  778  28,216 G - Unclassified Roads 1,837  83,524  720  83,521  720  85,274  801  85,717  3,557  113,974 Total  21,336  138,803  21,826  140,007  22,443  139,612  23,024  139,268  26,004  213,709 Source: Ministry of Transport & Infrastructure/ Kenya Roads Board 				*   Provisional				.. Data not available	 			 1For Definitions of the classifications used, see “ notes and definitions “ at the beginning of this chapter				 2Special purpose roads include Government access, Settlement, Rural access, Sugar, Tea and Wheat roads				Table 13.15:	 Traffic Handled at Coastal Ports and Inland Waterways , 2015-<b>2024</b>Number2015201620172018201920202021202220232025*ShipsContainer Specialised 514  477  583  576  552  539  541  539  810  872 Passenger  8  11  7  6  2  3  2  9  6  7 Bulk & Oil Tankers 462  452  521  492  519  507  515  474  440  409 General Dry Cargo 274  240  215  131  165  117  133  148  166  175 Others. 436  427  441  400  437  455  444  391  413  410 Total 1,694  1,607
---
291,858 Naivasha Port Traffic (TEUs)    10,089  391  7,617  6,294  8,410 Lamu Port traffic (MT) 34,761  6,539  37,576  74,380 Lamu Port Vessels (Number) 12  4  36
```
...
**Reasoning:** The question asks for the maize production in tonnes for the year 2025. The most recent publication is the National Agriculture Production Report 2025, which provides data for the year 2024. The report does not provide data for the year 2025. Therefore, an answer cannot be provided based on the given contexts. The highlighted keywords relate to the question as they mention maize production and the relevant years.

**Key phrases:** 2024NATIONAL AGRICULTURE PRODUCTION REPORT 9.3.1: Maize; 2023 to 4,285.2 thousand tonnes from 3,087.2 thousand tonnes in 2022; National Agriculture Production Report 2025; 4,028,320 tonnes; National Agriculture Production Report 2025 83.1 CEREALS3.1.1: Maize; 44.7 million 90-kilogramme bags in 2024

**Predicted source text:**

> <b>2024NATIONAL AGRICULTURE PRODUCTION REPORT 9.3.1: Maize</b>Maize is the most widely produced staple crop in Kenya, consumed by majority of households in both urban and rural areas. The area dedicated to maize cultivation increased from 2,113.5 thousand hectares in 2022 to 2,430.0 thousand hectares in 2023 (Table 3.2). The expansion was driven by favorable prices of maize in 2023. Aggregate maize production increased by 38.8 per cent in <b>2023 to 4,285.2 thousand tonnes from 3,087.2 thousand ...

<details><summary>Retrieved context chunks</summary>

```
<b>2024NATIONAL AGRICULTURE PRODUCTION REPORT 9.3.1: Maize</b>Maize is the most widely produced staple crop in Kenya, consumed by majority of households in both urban and rural areas. The area dedicated to maize cultivation increased from 2,113.5 thousand hectares in 2022 to 2,430.0 thousand hectares in 2023 (Table 3.2). The expansion was driven by favorable prices of maize in 2023. Aggregate maize production increased by 38.8 per cent in <b>2023 to 4,285.2 thousand tonnes from 3,087.2 thousand tonnes in 2022</b>. This increase in production was attributed to several factors, which include the government's subsidy of fertilizers, favorable weather conditions such as sufficient rainfall in 2023 and the expansion of the area under the crop. The value of Maize increased from KSh 179.7 billion in 2022 to KSh 180.8 billion in 2023. Table 3.3 shows the top 20 counties in production of Maize in 2023. Table 3.3: Top 20 Counties in Maize Production in 2023Table 3.2: Production and Value of Maize,
---
<b>National Agriculture Production Report 2025</b>xvExecutive SummaryFood CropsIn Kenya, maize is the most significant crop, both in terms of culti-vated area and total production. It was grown on 2,407,025  hectares and produced <b>4,028,320 tonnes</b>, highlighting its central role as the country’s staple cereal. Beans were the second most widely cultivated crop, covering 1,229,611 hectares and yielding 759,006 tonnes, while green grams ranked third in area at 300,858 hectares with a production of 117,220 tonnes. Despite being grown on a much smaller area, Irish potatoes emerged as the second most productive crop, generating 2,149,979 tonnes from 225,976 hectares. Cassava also demonstrated high productivity, yielding 1,207,592 tonnes from 82,042 hectares. HorticultureKenya’s horticulture sector, a vital component of the agricultural economy, experienced mixed performance in 2024 as the total cultivated area expanded to 476.7 thousand hectares. Overall pro-duction and value dec
```
...
**Reasoning:** The question asks for the area under maize cultivation in Kenya in 2024. The most relevant context is from Doc2, which provides the specific figure for 2024. The area under maize production decreased from 2,430.0 thousand hectares in 2023 to 2,407.2 thousand hectares in 2024. This information directly answers the question. The context is from the National Agriculture Production Report 2025, which is the most recent and relevant publication for the year 2024.

**Key phrases:** 2,430.0 thousand hectares in 2023; 2,407.2 thousand hectares in 2024

**Predicted source text:**

> 2024NATIONAL AGRICULTURE PRODUCTION REPORT 9.3.1: MaizeMaize is the most widely produced staple crop in Kenya, consumed by majority of households in both urban and rural areas. The area dedicated to maize cultivation increased from 2,113.5 thousand hectares in 2022 to <b>2,430.0 thousand hectares in 2023</b> (Table 3.2). The expansion was driven by favorable prices of maize in 2023. Aggregate maize production increased by 38.8 per cent in 2023 to 4,285.2 thousand tonnes from 3,087.2 thousand ton...
...
**Reasoning:** The question asks for the production of Irish potatoes in 2025, but the provided contexts do not contain data for 2025. The closest data available is for 2024, which is 2,153.6 thousand tonnes. However, this does not directly answer the question for 2025. The most relevant keywords highlight the sections discussing Irish potatoes and the production figures for the years closest to 2025.

**Key phrases:** 2024NATIONAL AGRICULTURE PRODUCTION REPORT 24.3.11: Irish Potatoes; 2,309.9 thousand tonnes in 2023; National Agriculture Production Report 2025 243.3 ROOTS AND TUBERS3.3.1: Irish Potatoes; 2,153.6 thousand tonnes in 2024; National Agriculture Production Report 2025; 2,149,979 tonnes from 225,976 hectares

**Predicted source text:**

> <b>2024NATIONAL AGRICULTURE PRODUCTION REPORT 24.3.11: Irish Potatoes</b>Potato is one of the key staple crops in Kenya which is grown in a wide range of conditions. In the period under review, production of Irish potatoes increased to 2,309.9 thousand tonnes from 1,831.8 thousand tonnes in 2022(Table 3.22). Similarly, the area increased from 231.5 thousand hectares in 2022 to 239.3 thousand hectares in 2023. The increase in production was attributed to enhanced rainfall received in 2023 as well...
...
|---|---|
| **Golden answer** | 0.87% |
| **Predicted answer** | The construction inflation rate in Kenya in Q4 2024 was 0.87 per cent. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.154 | Semantic=0.308 | Fuzzy=11.1 | EvidenceMatch=True | Scoring=numeric_match
...
**Reasoning:** The question asks for the construction inflation rate in Kenya in Q4 2024. The first context document directly provides this information, stating that 'The construction inflation rate was 0.87 per cent in Q4-2024.' This matches the question's requirements exactly. The second and third context documents also support the relevance of the first document by providing additional details about the Construction Input Price Indices for the same period.

**Key phrases:** construction inflation rate; Q4 2024; 0.87 per cent; Construction Input Price Indices; CIPI-Inflation Rate(%); Q4 2024; Construction Input Price Indices; FOURTH QUARTER 2024; DECEMBER 2024

**Predicted source text:**

> 2 | P a g e     <b>CONSTRUCTION INPUT PRICE INDICES</b> FOR THE <b>FOURTH QUARTER 2024</b>  The Kenya National Bureau of Statistics hereby releases Construction Input Price Indices (CIPI) for the fourth quarter of 2024. The indices are generated from price data collected from a representative sample of outlets that trade in construction materials. The prices are collected quarterly and are referenced to the 15th day of the mid-month of the quarter.  The CIPI and inflation rates are as shown in T...

<details><summary>Retrieved context chunks</summary>

```
2 | P a g e     <b>CONSTRUCTION INPUT PRICE INDICES</b> FOR THE <b>FOURTH QUARTER 2024</b>  The Kenya National Bureau of Statistics hereby releases Construction Input Price Indices (CIPI) for the fourth quarter of 2024. The indices are generated from price data collected from a representative sample of outlets that trade in construction materials. The prices are collected quarterly and are referenced to the 15th day of the mid-month of the quarter.  The CIPI and inflation rates are as shown in Tables 1 and 2.  The <b>construction inflation rate</b> was <b>0.87 per cent</b> in Q4-2024. Notable, <b>Q4 2024</b> recorded a decline (-0.80%) from Q3 2024, signaling a contraction in construction costs. There were general declines in the indices of material, labour, equipment, and Transport, Fuels and Lubricants in Q4-2024. The indices of quarry products, cement and hardcore decreased by 3.90, 1.94 and 2.40 per cent, respectively. Additionally, the indices of steel reinforcement bars, ballast and graded crushed stones
---
3 | P a g e   Table 1: <b>Construction Input Price Indices</b> and Inflation Rates  Year  Quarter  Construction Input Price Indices(CIPI)  CIPI- Inflation Rate(%) (Current Quarter/Previous Quarter)  <b>CIPI-Inflation Rate(%)</b>  (Current Quarter/Same quarter Previous Year) 1104.35               1.71                          3.26                         2106.02               1.61                          6.02                         3106.06               0.04                          3.61                         4106.12               0.05                          3.44                         1112.65               6.15                          7.96                         2114.47               1.62                          7.97                         3113.38               (0.95)                         6.90                         4113.65               0.24                          7.10                         1114.76               0.97
```
...
| **Predicted answer** | The United Kingdom and the Netherlands accounted for the largest shares of Kenya's foreign liabilities from Europe at the end of 2023, with 46.4 per cent and 17.3 per cent, respectively. Other major contributors were France and Switzerland, accounting for 13.4 per cent and 10.0 per cent, respectively. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.492 | Semantic=0.470 | Fuzzy=93.2 | EvidenceMatch=False | Scoring=numeric_match
...
**Reasoning:** The question asks for the European countries that accounted for the largest shares of Kenya's foreign liabilities from Europe at the end of 2023. The most relevant context is from the 2024 Foreign Investment Survey Report published on 01 August 2025, which provides specific figures for the end of 2023. The United Kingdom and the Netherlands are highlighted as the major contributors, with France and Switzerland also mentioned. The figures from the 2023 Foreign Investment Report are not used because they do not provide data for the end of 2023. The 2024 Foreign Investment Survey Report is the most recent and relevant document for the question.

**Key phrases:** the United Kingdom and the Netherlands, which accounted for 46.4 per cent and 17.3 per cent of the total stock of foreign liabilities from Europe, respectively, at the end of 2023; France and Switzerland accounting for 13.4 per cent and 10.0 per cent of the total stock of foreign liabilities from Europe, respectively, at the end of 2023; the United Kingdom and the Netherlands, which accounted for 46.4 per cent and 17.3 per cent, of the total stock of foreign liabilities from Europe, respectively, at the end of 2023; the United Kingdom, which contributed 47.2, 49.1 and 47.2 per cent of the total stock of liabilities at the end of 2020, 2021 and 2022, respectively
...
| **Predicted answer** | 26.4 per cent |
| **Should answer** | True |
| **Is refusal** | False |
...
**Reasoning:** The question asks for the percentage of Kenya's total foreign liabilities that came from Africa at the end of 2023. The most relevant context is from the 2024 Foreign Investment Survey Report, which directly states that 'Africa was the second largest source of foreign liabilities to Kenya, accounting for 26.6 per cent and 26.4 per cent of the total stock of foreign liabilities at the end of 2022 and 2023, respectively.' This directly answers the question with the specific percentage for 2023. The context is from the 2024 Foreign Investment Survey Report, published on 01 August 2025, which is the most recent and relevant document for the year 2023.

**Key phrases:** Africa was the second largest source of foreign liabilities to Kenya, accounting for 26.6 per cent and 26.4 per cent of the total stock of foreign liabilities at the end of 2022 and 2023, respectively.; Africa emerged as the second largest source of foreign liabilities, accounting for 26.4 per cent of the total stock of foreign liabilities at the end of 2023.

**Predicted source text:**

> of foreign liabilities from Europe, respectively. Notably, the stock of foreign liabilities from Finland, Denmark and Switzerland declined by 41.5, 39.4 and 14.5 per cent, respectively, at the end of 2023. 2.9. In the period under review, Africa was the second largest source of foreign liabilities to Kenya, accounting for 26.6 per cent and <b>26.4 per cent</b> of the total stock of foreign liabilities at the end of 2022 and 2023, respectively. The stock of foreign liabilities from Africa was maj...
...
| **Predicted answer** | 84.8 per cent |
| **Should answer** | True |
| **Is refusal** | False |
...
**Reasoning:** The question asks for Kenya's formal financial access rate in 2024. The most relevant context is from the 2025 Economic Survey, which directly states that 'Overall access to formal financial services has seen a substantial increase, expanding from the baseline of 26.7 per cent in 2006 to 84.8 per cent in 2024'. This figure is directly related to the question and provides the exact rate for 2024. The context from the 2025 Facts and Figures and the Quarterly Gross Domestic Product Report do not provide direct information on the formal financial access rate. The context from the 2025 Economic Survey (page 541) is the most relevant as it provides the direct figure for 2024.

**Key phrases:** Overall access to formal financial services has seen a substantial increase, expanding from the baseline of 26.7 per cent in 2006 to 84.8 per cent in 2024; Formal Financial Access by Residence
...
**Metrics:** EM=0 | F1=0.167 | Semantic=0.366 | Fuzzy=47.1 | EvidenceMatch=True | Scoring=numeric_match
...
**Reasoning:** The question asks for the percentage of Kenyans who used mobile money daily in 2024. The most relevant context is from the 2024 FinAccess Household Survey Report, which directly states that '52.6 percent of Kenyans now use mobile money daily'. This figure is from the most recent publication and directly answers the question. The other contexts also mention the increase in mobile money usage, but the exact figure for 2024 is only provided in the first context. The second and third contexts provide additional information about the increase in usage but do not provide the exact percentage for 2024. The first context is from the 2024 FinAccess Household Survey Report, which is the most relevant and recent publication. The second and third contexts are also from the 2024 FinAccess Household Survey Report, but they do not provide the exact percentage for 2024. The first context is the most relevant because it directly answers the question with the exact percentage for 2024.

**Key phrases:** 52.6 percent of Kenyans now use mobile money daily; 52.6 percent from 23.6 percent in 2021; daily usage of mobile money increased from 23.6 percent in 2021 to 50.2 percent

**Predicted source text:**

> 2024 FINACCESS HOUSEHOLD SURVEYviii5.	 Insurance, Pensions, and Securities: The use of NHIF has declined, possibly due to the ongoing transition to SHIF; NSSF usage has slightly increased due to the lifting of the NSSF Act (2013) =   . The use of securities has also increased with the introduction of apps.6.	 Payments: <b>52.6 percent of Kenyans now use mobile money daily</b>, more than doubling, from 23.6 percent in 2021, indicating increased digitilization in payments.7.	 Savings and Credit: W...
...
**Reasoning:** The question asks for the percentage of Kenyans who were financially healthy in 2024. The first context document, titled '2024 FinAccess Household Survey Report' published on 01 December 2024, directly provides this information. The exact text passage is 'Financial health remains low, with 18.3 percent of Kenyans financially healthy compared to 17.1 percent in 2021.' This matches the year 2024 and directly answers the question. The other documents do not contain relevant information for the year 2024.

**Key phrases:** Financial health remains low, with 18.3 percent of Kenyans financially healthy compared to 17.1 percent in 2021.; 2024 FINACCESS HOUSEHOLD SURVEY; 2024

**Predicted source text:**

> <b>2024</b> FINACCESS HOUSEHOLD SURVEYixon inflation, interest rates and risk diversification correctly.12.	 Financial Health: <b>Financial health remains low, with 18.3 percent of Kenyans financially healthy compared to 17.1 percent in 2021.</b> There was an improvement in the percentage of Kenyans able to manage day-to-day and cope with shocks, but a significant decline in those able to invest in the future.13.	 Green Finance: 34 percent of the population reported some form of green investment...
...
| **Predicted answer** | Nairobi City had the highest working population, at 2,191,913. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.500 | Semantic=0.733 | Fuzzy=57.8 | EvidenceMatch=True | Scoring=numeric_match
...
**Reasoning:** The question asks for the county with the highest working population as of 2022. The most relevant context is from Doc1, which directly states the working population figures for 2022. Nairobi City is explicitly mentioned as having the highest working population, with a figure of 2,191,913. This directly answers the question. The other documents do not provide specific working population figures for 2022, but Doc2 and Doc3 mention Nairobi City in relation to population and economically active population, respectively, which supports the information from Doc1. Doc4 and Doc5 do not provide relevant information for the year 2022.

**Key phrases:** Nairobi City has the highest working population, at 2,191,913; As of 2022, the total working population stood at nearly 20 million individuals; Nairobi City is expected to remain the most populous county; Nairobi City, Kiambu, Nakuru, Kakamega, Meru, Machakos and Bungoma
...
| **Predicted answer** | Pneumonia was the leading cause of registered health facility deaths in Mombasa County in 2024, with a total of 424 deaths. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.273 | Semantic=0.699 | Fuzzy=58.1 | EvidenceMatch=True | Scoring=numeric_match
...
**Reasoning:** The question asks for the leading cause of registered health facility deaths in Mombasa County in 2024. The first document provides a table specifically for Mombasa County in 2024, listing pneumonia as the leading cause with 424 deaths. The second and third documents support that pneumonia was a leading cause of death in health facilities in 2024, but do not provide county-specific data. Therefore, the most relevant and direct answer comes from the first document.

**Key phrases:** MOMBASA; RankCause of DeathTotal1Pneumonia424; 2024; Pneumonia has remained the top leading cause of health facility deaths since 2021; 2024; Pneumonia, cancer and cardiovascular diseases were leading causes of registered health facilities deaths in 2023 and 2024; 2024

**Predicted source text:**

> 188.KENYA VITAL STATISTICS REPORT <b>2024</b>Appendix 6-3: Ten Leading Registered Health Facility Causes of Death by County-2024001: <b>MOMBASA</b><b>RankCause of DeathTotal1Pneumonia424</b>2Cancer3453Hypertension2984Prematurity & Birth Asphyxia2365Sepsis2066Kidney Diseases1757Gastroenteritis1688Heart Disease1619Diabetes13810Road Traffic Accident12211All Other Causes1,855Total4, 128003: KILIFIRankCause of DeathTotal1Prematurity & Birth Asphyxia2482Pneumonia2273Cardio Vascular diseases2054Respira...
...
**Reasoning:** The question asks for the volume of export traffic through the port of Mombasa in 2023. The most relevant context is from Doc2, which provides the exact figure of 4,950 thousand metric tonnes for the year 2023. This figure is directly stated in the text and matches the period specified in the question. The context is from the 2024 Economic Survey, which is the most recent publication available and closely matches the year 2023 mentioned in the question.

**Key phrases:** The volume of export traffic through the port of Mombasa rose by 3.8 per cent from 4,771 thousand metric tonnes in 2022 to 4,950 thousand metric tonnes in 2023
...
**Reasoning:** The question asks for Kenya's broad money supply (M3) in August 2023. The provided contexts do not contain data for August 2023. The most recent data available is for August 2024. Therefore, an answer cannot be provided based on the given contexts.

**Key phrases:** Broad Money (M3); August 2023; M3; Money supply (M3)

**Predicted source text:**

> 1,341,737      5,965,620 1.98July ..  ..  ..  ..  .. ..August ..  ..  ..  ..  ..  .. Source: Central Bank of Kenya(Expanded)* Currency in circulation less cash in banks plus all demand deposits except those of National & County government, Banks, non-residents and foreign currency deposits** All other deposits in commercial banks, except those of National government.***Broad money (M2) is the sum of M1, Quasi money in Banks and Quasi money in NBFIs..**** Broad Money (<b>M3</b>) includes M2 and F...

<details><summary>Retrieved context chunks</summary>

```
1,341,737      5,965,620 1.98July ..  ..  ..  ..  .. ..August ..  ..  ..  ..  ..  .. Source: Central Bank of Kenya(Expanded)* Currency in circulation less cash in banks plus all demand deposits except those of National & County government, Banks, non-residents and foreign currency deposits** All other deposits in commercial banks, except those of National government.***Broad money (M2) is the sum of M1, Quasi money in Banks and Quasi money in NBFIs..**** Broad Money (<b>M3</b>) includes M2 and Foreign currency depositsM2=(M1+QM-NBFIs)M3=M2+FCD1 Percentage change of M3.. Data not availableKSh millionDescriptions/ Period
---
P a g e  | 11 Leading Economic Indicators August 2024  Table 5(a): Money Supply  Money (M1)*  Quasi – Money** Total (M2)*** Foreign currency deposits Broad Money (<b>M3</b>)****  % Change 12023January     1,924,057       2,207,127     4,131,184         946,482      5,077,667 0.70February     2,078,290       2,040,000     4,118,289         983,950      5,102,239 0.48March     1,863,118       2,275,530     4,138,648      1,059,005      5,197,653 1.87April     1,903,795       2,278,837     4,182,632      1,076,341      5,258,973 1.18May     1,901,808       2,315,945     4,217,753      1,092,168      5,309,921 0.97June     2,072,813       2,309,052     4,389,251      1,186,189      5,575,440 5.00July     2,106,487       2,318,937     4,425,424      1,248,373      5,673,797 1.76August     2,086,516       2,359,553     4,446,069      1,328,576      5,774,645 1.78September     2,000,269       2,441,742     4,442,011      1,399,119      5,841,131 1.15October     2,000,657       2,431,176
---
5,774,645 1.78September     2,000,269       2,441,742     4,442,011      1,399,119      5,841,131 1.15October     2,000,657       2,431,176     4,431,833      1,450,890      5,882,723 0.71November     1,995,418       2,459,115     4,454,532      1,497,797      5,952,329 1.18December     2,024,523       2,471,815     4,496,338      1,548,195      6,044,533 1.552024Janu
```
...
| **Predicted answer** | The employed had the highest formal financial access rate at 96.9 percent. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.400 | Semantic=0.587 | Fuzzy=54.0 | EvidenceMatch=True | Scoring=numeric_match
...
**Reasoning:** The question asks for the livelihood group with the highest formal financial access rate according to the 2024 FinAccess Survey. The first context document provides the specific percentages for different livelihood groups, with the employed having the highest rate at 96.9 percent. This directly answers the question. The second and third context documents do not provide relevant information for this specific question.

**Key phrases:** The employed and those who own businesses had the highest access to financial services through formal channels at 96.9 percent and 92.3 percent, respectively.; The employed; 96.9 percent
...
182024 FINACCESS HOUSEHOLD SURVEYFigure 2.10: Financial Inclusion by Livelihoods (%)2.8	ACCESS BY LIVELIHOOD<b>The employed</b> and those who own businesses had the highest access to financial services through formal channels at <b>96.9 percent</b> and 92.3 percent, respectively. The population that own business and casuals that access formal financial services recorded a decrease in 2024. However, casu...
...
---
162024 FINACCESS HOUSEHOLD SURVEY2.6	ACCESS BY EDUCATIONEducation level of an individual plays a major role in determining access to formal financial services and products. Education influences access to information thereby increasing capacity to m
```
...
**Metrics:** EM=0 | F1=0.400 | Semantic=0.418 | Fuzzy=46.9 | EvidenceMatch=True | Scoring=numeric_match
...
**Reasoning:** The question asks for the top three export destinations for Kenyan coffee in the 2023/24 coffee year. The first context document, National Agriculture Production Report 2025, directly provides this information. The relevant passage is: 'In the coffee year 2023/24 a total of 59 destinations imported coffee from Kenya which was 7 more than the previous season of 2022/23. As shown in Table 5.1.5, the top leading export destinations for Kenyan coffee in the 2023/24 coffee year were Belgium, USA and Germany at 16.8 per cent, 16.1 per cent and 11.4 per cent, respectively.' This passage directly answers the question by listing the top three export destinations and their respective percentages.

**Key phrases:** top leading export destinations for Kenyan coffee in the 2023/24 coffee year were Belgium, USA and Germany at 16.8 per cent, 16.1 per cent and 11.4 per cent, respectively; 2023/24 coffee year

**Predicted source text:**

> National Agriculture Production Report 2025 62In the coffee year 2023/24 a total of 59 destinations imported coffee from Kenya which was 7 more than the previous season of 2022/23. As shown in Table 5.1.5, the top leading export destinations for Kenyan coffee in the <b>2023/24 coffee year</b> were Belgium, USA and Germany at 16.8 per cent, 16.1 per cent and 11.4 per cent, respectively. The in-crease in volumes exported to Belgium is attributed to marketing campaigns done by Agriculture and Food ...
...
**Reasoning:** The question asks for the county with the largest meat goat population in 2024. The most relevant context is Doc2, which provides data for 2024. However, the context does not specify which county had the largest population. The context lists the top 10 counties for meat goat rearing but does not provide the exact numbers for each county. Therefore, it is not possible to determine which county had the largest meat goat population based on the provided information.

**Key phrases:** Top 10 Meat Goats Rearing Counties, 2024; Turkana; Garissa; Mandera; Wajir; Kitui; Isiolo; Baringo; Kajiado; Narok; Tana River
...
| **Predicted answer** | Beans were the second most widely cultivated crop, covering 1,229,611 hectares. |
| **Should answer** | True |
| **Is refusal** | False |

**Metrics:** EM=0 | F1=0.571 | Semantic=0.725 | Fuzzy=69.2 | EvidenceMatch=True | Scoring=numeric_match
...
**Reasoning:** The question asks for the second most widely cultivated crop in Kenya after maize and the area it covered. The most relevant context is from the National Agriculture Production Report 2025, which directly states that 'Beans were the second most widely cultivated crop, covering 1,229,611 hectares'. This information is directly quoted from the context, making it the most accurate and relevant answer. The date in the question is not specified, so the most recent publication is used. The context provides the exact area covered by beans, which matches the question's requirement.

**Key phrases:** Beans were the second most widely cultivated crop, covering 1,229,611 hectares; Beans were the second most widely cultivated crop; 1,229,611 hectares; ranked second in terms of area cultivated, covering 1,229,611 hectares

**Predicted source text:**

> National Agriculture Production Report 2025xvExecutive SummaryFood CropsIn Kenya, maize is the most significant crop, both in terms of culti-vated area and total production. It was grown on 2,407,025  hectares and produced 4,028,320 tonnes, highlighting its central role as the country’s staple cereal. <b>Beans were the second most widely cultivated crop</b>, covering <b>1,229,611 hectares</b> and yielding 759,006 tonnes, while green grams ranked third in area at 300,858 hectares with a productio...

<details><summary>Retrieved context chunks</summary>

```
National Agriculture Production Report 2025xvExecutive SummaryFood CropsIn Kenya, maize is the most significant crop, both in terms of culti-vated area and total production. It was grown on 2,407,025  hectares and produced 4,028,320 tonnes, highlighting its central role as the country’s staple cereal. <b>Beans were the second most widely cultivated crop</b>, covering <b>1,229,611 hectares</b> and yielding 759,006 tonnes, while green grams ranked third in area at 300,858 hectares with a production of 117,220 tonnes. Despite being grown on a much smaller area, Irish potatoes emerged as the second most productive crop, generating 2,149,979 tonnes from 225,976 hectares. Cassava also demonstrated high productivity, yielding 1,207,592 tonnes from 82,042 hectares. HorticultureKenya’s horticulture sector, a vital component of the agricultural economy, experienced mixed performance in 2024 as the total cultivated area expanded to 476.7 thousand hectares. Overall pro-duction and value declined, largely due
---
ranked second in terms of area cultivated, covering <b>1,229,611 hectares</b> yielding 759,006 tonnes. Green grams came in third by area, occupying 300,858 hectares with a production of 117,220 tonnes. Irish potatoes were the second most productive crop, generating 2,149,979 tons from 225,976 hectares followed by cassava cultivated on 82,042 hectares, achieving a total production of 1,207,592 tons. While maize continues to dominate, crops like Irish potatoes and cassava stand out for their high productivity despite limited cultivated area. In contrast, beans and green grams, though widely grown, are underperforming in terms of yield. IntroductionTable 3.1: Summary Food Crops Production, 2020-2024Year20202021202220232024*Area/ProductionArea (Ha)Production (Tons)Area (Ha)Production (Tons)Area (Ha)Production (Tons)Area (Ha)Production (Tons)Area (Ha)Production (Tons)Maize2,171,6953,795,1702,168,6033,304,4302,113,5203,082,2202,430,0144,285,2062,407,025 4,028,320
---
2024NATI
```
