...
class Inquirer:
    ...
    def translate_to_english(self, text: str) -> str:
        ...
        """
        try:
            return self.sw_to_en_translator(text)
    ...
    def translate_to_swahili(self, text:str) -> str:
        ...
        """
        try:
            return self.en_to_sw_translator(text)
        except Exception as e:
    ...
    def make_query(
        ...
        if language == "sw":
            try:
                ...
                # Get translated question out of dictionary in English
                for dictionary in english_query:
        ...
        if language == "sw":
            ...
            try:
                ...
                # Get translated answer out of dictionary in Swahili
                for dictionary in answer_str:
                    for translation in dictionary.values():
                        answer_str = translation
