...
from transformers import AutoTokenizer, AutoModelForSeq2SeqLM # For translation
...
class Inquirer:
    ...
    def __init__(
        ...
        #self.sw_to_en_translator = pipeline("translation", model="Rogendo/sw-en")
        #self.en_to_sw_translator = pipeline("translation", model="Rogendo/en-sw")
    ...
    def translator(self, text: str, translate_to: str) -> str:
        """
        Translates Swahili text to English or English text to Swahili
    ...
    def make_query(
        self,
        question: str,
        language: str = "sw", # default language is english
        ...
        if language == "sw":
            try:
                ...
                english_query = self.translator(question, translate_to = "en")
        ...
        if language == "sw":
            ...
            try:
                #answer_str = self.en_to_sw_translator(answer_str)
                answer_str = self.translator(answer_str, translate_to = "sw")
        ...
        return docs, answer_str, validated_response, english_query
...
if __name__ == "__main__":
    ...
    docs, answer, response, english_query = inquirer.make_query(
        question,
        latest_filter="off",
    )
